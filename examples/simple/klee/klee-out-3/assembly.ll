...
@.str2 = private unnamed_addr constant [7 x i8] c"y >= 0\00", align 1
@.str3 = private unnamed_addr constant [9 x i8] c"klee_3.c\00", align 1
...
entry:
  ...
  %3 = zext i1 %2 to i64, !dbg !128
  call void @klee_assume(i64 %3) nounwind, !dbg !128
  %4 = load i32* %x, align 4, !dbg !129
  %5 = load i32* %y, align 4, !dbg !129
  %6 = add nsw i32 %4, %5, !dbg !129
  %7 = mul nsw i32 %6, 2, !dbg !129
  %8 = icmp sge i32 %7, -1, !dbg !129
  %9 = zext i1 %8 to i64, !dbg !129
  call void @klee_assume(i64 %9) nounwind, !dbg !129
  %10 = load i32* %y, align 4, !dbg !130
  %11 = icmp slt i32 %10, 0, !dbg !130
  br i1 %11, label %bb, label %bb3, !dbg !130

bb:                                               ; preds = %entry
  %12 = call i32 (...)* @__assert_fail(i8* getelementptr inbounds ([7 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8]* @.str3, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([5 x i8]* @__PRETTY_FUNCTION__.2613, i64 0, i64 0)) nounw
  unreachable

bb3:                                              ; preds = %entry
  store i32 0, i32* %0, align 4, !dbg !131
  %13 = load i32* %0, align 4, !dbg !131
  store i32 %13, i32* %retval, align 4, !dbg !131
  %retval4 = load i32* %retval, !dbg !131
  ret i32 %retval4, !dbg !131
}
...
!0 = metadata !{i32 589870, i32 0, metadata !1, metadata !"main", metadata !"main", metadata !"main", metadata !1, i32 8, metadata !3, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 (i32, i8**)* @main} ; [ DW_TAG_subprogram ]
!1 = metadata !{i32 589865, metadata !"klee_3.c", metadata !"/home/lijiaying/Research/interpolants/package.3/klee/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"klee_3.c", metadata !"/home/lijiaying/Research/interpolants/package.3/klee/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_com
...
!126 = metadata !{i32 589835, metadata !0, i32 8, i32 0, metadata !1, i32 0} ; [ DW_TAG_lexical_block ]
!127 = metadata !{i32 13, i32 0, metadata !126, null}
!128 = metadata !{i32 15, i32 0, metadata !126, null}
!129 = metadata !{i32 16, i32 0, metadata !126, null}
!130 = metadata !{i32 17, i32 0, metadata !126, null}
!131 = metadata !{i32 18, i32 0, metadata !126, null}
