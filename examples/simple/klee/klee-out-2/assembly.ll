...
@.str3 = private unnamed_addr constant [9 x i8] c"klee_2.c\00", align 1
...
entry:
  ...
  %4 = mul nsw i32 %3, 2, !dbg !128
  %5 = icmp sge i32 %4, -1, !dbg !128
  %6 = zext i1 %5 to i64, !dbg !128
  call void @klee_assume(i64 %6) nounwind, !dbg !128
  %7 = load i32* %x, align 4, !dbg !129
  %8 = icmp sge i32 %7, 0, !dbg !129
  %9 = zext i1 %8 to i64, !dbg !129
  call void @klee_assume(i64 %9) nounwind, !dbg !129
  %10 = load i32* %x, align 4, !dbg !130
  %11 = sub nsw i32 %10, 1, !dbg !130
  store i32 %11, i32* %x, align 4, !dbg !130
  %12 = load i32* %y, align 4, !dbg !131
  %13 = add nsw i32 %12, 1, !dbg !131
  store i32 %13, i32* %y, align 4, !dbg !131
  %14 = load i32* %x, align 4, !dbg !132
  %15 = load i32* %y, align 4, !dbg !132
  %16 = add nsw i32 %14, %15, !dbg !132
  %17 = mul nsw i32 %16, 2, !dbg !132
  %18 = icmp slt i32 %17, -1, !dbg !132
  br i1 %18, label %bb, label %bb3, !dbg !132

bb:                                               ; preds = %entry
  %19 = call i32 (...)* @__assert_fail(i8* getelementptr inbounds ([24 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8]* @.str3, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([5 x i8]* @__PRETTY_FUNCTION__.2613, i64 0, i64 0)) noun
  unreachable

bb3:                                              ; preds = %entry
  store i32 0, i32* %0, align 4, !dbg !133
  %20 = load i32* %0, align 4, !dbg !133
  store i32 %20, i32* %retval, align 4, !dbg !133
  %retval4 = load i32* %retval, !dbg !133
  ret i32 %retval4, !dbg !133
}
...
!1 = metadata !{i32 589865, metadata !"klee_2.c", metadata !"/home/lijiaying/Research/interpolants/package.3/klee/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"klee_2.c", metadata !"/home/lijiaying/Research/interpolants/package.3/klee/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_com
...
!125 = metadata !{i32 11, i32 0, metadata !126, null}
!126 = metadata !{i32 589835, metadata !0, i32 7, i32 0, metadata !1, i32 0} ; [ DW_TAG_lexical_block ]
!127 = metadata !{i32 12, i32 0, metadata !126, null}
!128 = metadata !{i32 13, i32 0, metadata !126, null}
!129 = metadata !{i32 14, i32 0, metadata !126, null}
!130 = metadata !{i32 15, i32 0, metadata !126, null}
!131 = metadata !{i32 16, i32 0, metadata !126, null}
!132 = metadata !{i32 17, i32 0, metadata !126, null}
!133 = metadata !{i32 18, i32 0, metadata !126, null}
