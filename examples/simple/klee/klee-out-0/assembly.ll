...
@.str2 = private unnamed_addr constant [24 x i8] c"(2) * x + (2) * y >= -1\00", align 1
@.str3 = private unnamed_addr constant [9 x i8] c"klee_1.c\00", align 1
@__PRETTY_FUNCTION__.2613 = internal unnamed_addr constant [5 x i8] c"main\00"
...
entry:
  ...
  %x1 = bitcast i32* %x to i8*, !dbg !125
  call void @klee_make_symbolic(i8* %x1, i64 4, i8* getelementptr inbounds ([2 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !125
  %y2 = bitcast i32* %y to i8*, !dbg !127
  call void @klee_make_symbolic(i8* %y2, i64 4, i8* getelementptr inbounds ([2 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !127
  %1 = load i32* %x, align 4, !dbg !128
  %2 = load i32* %y, align 4, !dbg !128
  %3 = add nsw i32 %1, %2, !dbg !128
  %4 = icmp sle i32 %3, 0, !dbg !128
  %5 = load i32* %x, align 4, !dbg !128
  %6 = icmp sgt i32 %5, 9999, !dbg !128
  %or.cond = or i1 %4, %6
  br i1 %or.cond, label %bb5, label %bb3, !dbg !128

bb3:                                              ; preds = %entry
  %7 = load i32* %y, align 4, !dbg !128
  %8 = icmp sgt i32 %7, 9999, !dbg !128
  br i1 %8, label %bb5, label %bb4, !dbg !128

bb4:                                              ; preds = %bb3
  store i32 1, i32* %iftmp.0, align 4, !dbg !128
  br label %bb6, !dbg !128

bb5:                                              ; preds = %bb3, %entry
  store i32 0, i32* %iftmp.0, align 4, !dbg !128
  br label %bb6, !dbg !128

bb6:                                              ; preds = %bb5, %bb4
  %9 = load i32* %iftmp.0, align 4, !dbg !128
  %10 = sext i32 %9 to i64, !dbg !128
  call void @klee_assume(i64 %10) nounwind, !dbg !128
  %11 = load i32* %x, align 4, !dbg !129
  %12 = load i32* %y, align 4, !dbg !129
  %13 = add nsw i32 %11, %12, !dbg !129
  %14 = mul nsw i32 %13, 2, !dbg !129
  %15 = icmp slt i32 %14, -1, !dbg !129
  br i1 %15, label %bb7, label %bb8, !dbg !129

bb7:                                              ; preds = %bb6
  %16 = call i32 (...)* @__assert_fail(i8* getelementptr inbounds ([24 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8]* @.str3, i64 0, i64 0), i32 20, i8* getelementptr inbounds ([5 x i8]* @__PRETTY_FUNCTION__.2613, i64 0, i64 0)) noun
  unreachable

bb8:                                              ; preds = %bb6
  store i32 0, i32* %0, align 4, !dbg !130
  %17 = load i32* %0, align 4, !dbg !130
  store i32 %17, i32* %retval, align 4, !dbg !130
  %retval9 = load i32* %retval, !dbg !130
  ret i32 %retval9, !dbg !130
}
...
entry:
  %0 = icmp eq i64 %z, 0, !dbg !131
  br i1 %0, label %bb, label %return, !dbg !131
...
entry:
  ...
  %x1 = bitcast i32* %x to i8*, !dbg !135
  call void @klee_make_symbolic(i8* %x1, i64 4, i8* %name) nounwind, !dbg !135
  %0 = load i32* %x, align 4, !dbg !136
  ret i32 %0, !dbg !136
}

define void @klee_overshift_check(i64 %bitWidth, i64 %shift) nounwind {
entry:
  %0 = icmp ult i64 %shift, %bitWidth, !dbg !137
  br i1 %0, label %return, label %bb, !dbg !137
...
entry:
  %x = alloca i32, align 4
  %0 = icmp slt i32 %start, %end, !dbg !141
  br i1 %0, label %bb1, label %bb, !dbg !141

bb:                                               ; preds = %entry
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) noreturn nounwind, !dbg !142
  unreachable, !dbg !142

bb1:                                              ; preds = %entry
  %1 = add nsw i32 %start, 1, !dbg !143
  %2 = icmp eq i32 %1, %end, !dbg !143
  br i1 %2, label %bb8, label %bb3, !dbg !143

bb3:                                              ; preds = %bb1
  %x4 = bitcast i32* %x to i8*, !dbg !144
  call void @klee_make_symbolic(i8* %x4, i64 4, i8* %name) nounwind, !dbg !144
  %3 = icmp eq i32 %start, 0, !dbg !145
  %4 = load i32* %x, align 4, !dbg !146
  br i1 %3, label %bb5, label %bb6, !dbg !145

bb5:                                              ; preds = %bb3
  %5 = icmp ult i32 %4, %end, !dbg !146
  %6 = zext i1 %5 to i64, !dbg !146
  call void @klee_assume(i64 %6) nounwind, !dbg !146
  br label %bb7, !dbg !146

bb6:                                              ; preds = %bb3
  %7 = icmp sge i32 %4, %start, !dbg !147
  %8 = zext i1 %7 to i64, !dbg !147
  call void @klee_assume(i64 %8) nounwind, !dbg !147
  %9 = load i32* %x, align 4, !dbg !148
  %10 = icmp slt i32 %9, %end, !dbg !148
  %11 = zext i1 %10 to i64, !dbg !148
  call void @klee_assume(i64 %11) nounwind, !dbg !148
  br label %bb7, !dbg !148

bb7:                                              ; preds = %bb6, %bb5
  %12 = load i32* %x, align 4, !dbg !149
  br label %bb8, !dbg !149
...
entry:
  %0 = icmp eq i64 %len, 0, !dbg !151
  br i1 %0, label %bb2, label %bb, !dbg !151
...
bb:                                               ; preds = %bb, %entry
  ...
  %1 = load i8* %src.06, align 1, !dbg !152
  store i8 %1, i8* %dest.05, align 1, !dbg !152
  %indvar.next = add i64 %indvar, 1
  %exitcond1 = icmp eq i64 %indvar.next, %len
  br i1 %exitcond1, label %bb1.bb2_crit_edge, label %bb, !dbg !151
...
!1 = metadata !{i32 589865, metadata !"klee_1.c", metadata !"/home/lijiaying/Research/interpolants/package.3/klee/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"klee_1.c", metadata !"/home/lijiaying/Research/interpolants/package.3/klee/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_com
...
!125 = metadata !{i32 10, i32 0, metadata !126, null}
!126 = metadata !{i32 589835, metadata !0, i32 7, i32 0, metadata !1, i32 0} ; [ DW_TAG_lexical_block ]
!127 = metadata !{i32 11, i32 0, metadata !126, null}
!128 = metadata !{i32 12, i32 0, metadata !126, null}
!129 = metadata !{i32 20, i32 0, metadata !126, null}
!130 = metadata !{i32 21, i32 0, metadata !126, null}
!131 = metadata !{i32 13, i32 0, metadata !132, null}
!132 = metadata !{i32 589835, metadata !9, i32 12, i32 0, metadata !10, i32 0} ; [ DW_TAG_lexical_block ]
!133 = metadata !{i32 14, i32 0, metadata !132, null}
!134 = metadata !{i32 15, i32 0, metadata !132, null}
!135 = metadata !{i32 15, i32 0, metadata !79, null}
!136 = metadata !{i32 16, i32 0, metadata !79, null}
!137 = metadata !{i32 21, i32 0, metadata !138, null}
!138 = metadata !{i32 589835, metadata !24, i32 20, i32 0, metadata !25, i32 0} ; [ DW_TAG_lexical_block ]
!139 = metadata !{i32 27, i32 0, metadata !138, null}
!140 = metadata !{i32 29, i32 0, metadata !138, null}
!141 = metadata !{i32 16, i32 0, metadata !86, null}
!142 = metadata !{i32 17, i32 0, metadata !86, null}
!143 = metadata !{i32 19, i32 0, metadata !86, null}
!144 = metadata !{i32 22, i32 0, metadata !86, null}
!145 = metadata !{i32 25, i32 0, metadata !86, null}
!146 = metadata !{i32 26, i32 0, metadata !86, null}
!147 = metadata !{i32 28, i32 0, metadata !86, null}
!148 = metadata !{i32 29, i32 0, metadata !86, null}
!149 = metadata !{i32 32, i32 0, metadata !86, null}
!150 = metadata !{i32 20, i32 0, metadata !86, null}
!151 = metadata !{i32 15, i32 0, metadata !111, null}
!152 = metadata !{i32 16, i32 0, metadata !111, null}
!153 = metadata !{i32 17, i32 0, metadata !111, null}
