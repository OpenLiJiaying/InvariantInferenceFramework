...
entry:
  ...
  %4 = icmp sgt i32 %3, 0, !dbg !128
  %5 = zext i1 %4 to i64, !dbg !128
  call void @klee_assume(i64 %5) nounwind, !dbg !128
  %6 = load i32* %x, align 4, !dbg !129
  %7 = icmp sle i32 %6, 9999, !dbg !129
  %8 = zext i1 %7 to i64, !dbg !129
  call void @klee_assume(i64 %8) nounwind, !dbg !129
  %9 = load i32* %y, align 4, !dbg !130
  %10 = icmp sle i32 %9, 9999, !dbg !130
  %11 = zext i1 %10 to i64, !dbg !130
  call void @klee_assume(i64 %11) nounwind, !dbg !130
  %12 = load i32* %x, align 4, !dbg !131
  %13 = load i32* %y, align 4, !dbg !131
  %14 = add nsw i32 %12, %13, !dbg !131
  %15 = mul nsw i32 %14, 2, !dbg !131
  %16 = icmp slt i32 %15, -1, !dbg !131
  br i1 %16, label %bb, label %bb3, !dbg !131

bb:                                               ; preds = %entry
  %17 = call i32 (...)* @__assert_fail(i8* getelementptr inbounds ([24 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8]* @.str3, i64 0, i64 0), i32 22, i8* getelementptr inbounds ([5 x i8]* @__PRETTY_FUNCTION__.2613, i64 0, i64 0)) noun
  unreachable

bb3:                                              ; preds = %entry
  store i32 0, i32* %0, align 4, !dbg !132
  %18 = load i32* %0, align 4, !dbg !132
  store i32 %18, i32* %retval, align 4, !dbg !132
  %retval4 = load i32* %retval, !dbg !132
  ret i32 %retval4, !dbg !132
}
...
entry:
  %0 = icmp eq i64 %z, 0, !dbg !133
  br i1 %0, label %bb, label %return, !dbg !133
...
entry:
  ...
  %x1 = bitcast i32* %x to i8*, !dbg !137
  call void @klee_make_symbolic(i8* %x1, i64 4, i8* %name) nounwind, !dbg !137
  %0 = load i32* %x, align 4, !dbg !138
  ret i32 %0, !dbg !138
}

define void @klee_overshift_check(i64 %bitWidth, i64 %shift) nounwind {
entry:
  %0 = icmp ult i64 %shift, %bitWidth, !dbg !139
  br i1 %0, label %return, label %bb, !dbg !139
...
entry:
  %x = alloca i32, align 4
  %0 = icmp slt i32 %start, %end, !dbg !143
  br i1 %0, label %bb1, label %bb, !dbg !143

bb:                                               ; preds = %entry
  call void @klee_report_error(i8* getelementptr inbounds ([13 x i8]* @.str6, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([14 x i8]* @.str17, i64 0, i64 0), i8* getelementptr inbounds ([5 x i8]* @.str28, i64 0, i64 0)) noreturn nounwind, !dbg !144
  unreachable, !dbg !144

bb1:                                              ; preds = %entry
  %1 = add nsw i32 %start, 1, !dbg !145
  %2 = icmp eq i32 %1, %end, !dbg !145
  br i1 %2, label %bb8, label %bb3, !dbg !145

bb3:                                              ; preds = %bb1
  %x4 = bitcast i32* %x to i8*, !dbg !146
  call void @klee_make_symbolic(i8* %x4, i64 4, i8* %name) nounwind, !dbg !146
  %3 = icmp eq i32 %start, 0, !dbg !147
  %4 = load i32* %x, align 4, !dbg !148
  br i1 %3, label %bb5, label %bb6, !dbg !147

bb5:                                              ; preds = %bb3
  %5 = icmp ult i32 %4, %end, !dbg !148
  %6 = zext i1 %5 to i64, !dbg !148
  call void @klee_assume(i64 %6) nounwind, !dbg !148
  br label %bb7, !dbg !148

bb6:                                              ; preds = %bb3
  %7 = icmp sge i32 %4, %start, !dbg !149
  %8 = zext i1 %7 to i64, !dbg !149
  call void @klee_assume(i64 %8) nounwind, !dbg !149
  %9 = load i32* %x, align 4, !dbg !150
  %10 = icmp slt i32 %9, %end, !dbg !150
  %11 = zext i1 %10 to i64, !dbg !150
  call void @klee_assume(i64 %11) nounwind, !dbg !150
  br label %bb7, !dbg !150

bb7:                                              ; preds = %bb6, %bb5
  %12 = load i32* %x, align 4, !dbg !151
...
entry:
  %0 = icmp eq i64 %len, 0, !dbg !153
  br i1 %0, label %bb2, label %bb, !dbg !153
...
bb:                                               ; preds = %bb, %entry
  ...
  %1 = load i8* %src.06, align 1, !dbg !154
  store i8 %1, i8* %dest.05, align 1, !dbg !154
  %indvar.next = add i64 %indvar, 1
  %exitcond1 = icmp eq i64 %indvar.next, %len
  br i1 %exitcond1, label %bb1.bb2_crit_edge, label %bb, !dbg !153
...
!129 = metadata !{i32 13, i32 0, metadata !126, null}
!130 = metadata !{i32 14, i32 0, metadata !126, null}
!131 = metadata !{i32 22, i32 0, metadata !126, null}
!132 = metadata !{i32 23, i32 0, metadata !126, null}
!133 = metadata !{i32 13, i32 0, metadata !134, null}
!134 = metadata !{i32 589835, metadata !9, i32 12, i32 0, metadata !10, i32 0} ; [ DW_TAG_lexical_block ]
!135 = metadata !{i32 14, i32 0, metadata !134, null}
!136 = metadata !{i32 15, i32 0, metadata !134, null}
!137 = metadata !{i32 15, i32 0, metadata !79, null}
!138 = metadata !{i32 16, i32 0, metadata !79, null}
!139 = metadata !{i32 21, i32 0, metadata !140, null}
!140 = metadata !{i32 589835, metadata !24, i32 20, i32 0, metadata !25, i32 0} ; [ DW_TAG_lexical_block ]
!141 = metadata !{i32 27, i32 0, metadata !140, null}
!142 = metadata !{i32 29, i32 0, metadata !140, null}
!143 = metadata !{i32 16, i32 0, metadata !86, null}
!144 = metadata !{i32 17, i32 0, metadata !86, null}
!145 = metadata !{i32 19, i32 0, metadata !86, null}
!146 = metadata !{i32 22, i32 0, metadata !86, null}
!147 = metadata !{i32 25, i32 0, metadata !86, null}
!148 = metadata !{i32 26, i32 0, metadata !86, null}
!149 = metadata !{i32 28, i32 0, metadata !86, null}
!150 = metadata !{i32 29, i32 0, metadata !86, null}
!151 = metadata !{i32 32, i32 0, metadata !86, null}
!152 = metadata !{i32 20, i32 0, metadata !86, null}
!153 = metadata !{i32 15, i32 0, metadata !111, null}
!154 = metadata !{i32 16, i32 0, metadata !111, null}
!155 = metadata !{i32 17, i32 0, metadata !111, null}
