...
@.str2 = private unnamed_addr constant [11 x i8] c"x + y > -1\00", align 1
...
entry:
  ...
  %15 = icmp sle i32 %14, -1, !dbg !131
  br i1 %15, label %bb, label %bb3, !dbg !131

bb:                                               ; preds = %entry
  %16 = call i32 (...)* @__assert_fail(i8* getelementptr inbounds ([11 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8]* @.str3, i64 0, i64 0), i32 22, i8* getelementptr inbounds ([5 x i8]* @__PRETTY_FUNCTION__.2613, i64 0, i64 0)) noun
  unreachable

bb3:                                              ; preds = %entry
  store i32 0, i32* %0, align 4, !dbg !132
  %17 = load i32* %0, align 4, !dbg !132
...
!1 = metadata !{i32 589865, metadata !"klee_1.c", metadata !"/home/lijiaying/Research/github/FIIF/examples/f1a/klee/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"klee_1.c", metadata !"/home/lijiaying/Research/github/FIIF/examples/f1a/klee/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_c
