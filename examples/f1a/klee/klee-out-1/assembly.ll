...
entry:
  ...
  %4 = icmp sgt i32 %3, -1, !dbg !128
  %5 = zext i1 %4 to i64, !dbg !128
  call void @klee_assume(i64 %5) nounwind, !dbg !128
  %6 = load i32* %x, align 4, !dbg !129
  %7 = icmp sge i32 %6, 0, !dbg !129
  %8 = zext i1 %7 to i64, !dbg !129
  call void @klee_assume(i64 %8) nounwind, !dbg !129
  %9 = load i32* %x, align 4, !dbg !130
  %10 = sub nsw i32 %9, 1, !dbg !130
  store i32 %10, i32* %x, align 4, !dbg !130
  %11 = load i32* %y, align 4, !dbg !131
  %12 = add nsw i32 %11, 1, !dbg !131
  store i32 %12, i32* %y, align 4, !dbg !131
  %13 = load i32* %x, align 4, !dbg !132
  %14 = load i32* %y, align 4, !dbg !132
  %15 = add nsw i32 %13, %14, !dbg !132
  %16 = icmp sle i32 %15, -1, !dbg !132
  br i1 %16, label %bb, label %bb3, !dbg !132

bb:                                               ; preds = %entry
  %17 = call i32 (...)* @__assert_fail(i8* getelementptr inbounds ([11 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8]* @.str3, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([5 x i8]* @__PRETTY_FUNCTION__.2613, i64 0, i64 0)) noun
  unreachable

bb3:                                              ; preds = %entry
  store i32 0, i32* %0, align 4, !dbg !133
  %18 = load i32* %0, align 4, !dbg !133
  store i32 %18, i32* %retval, align 4, !dbg !133
...
!1 = metadata !{i32 589865, metadata !"klee_2.c", metadata !"/home/lijiaying/Research/github/FIIF/examples/f1a/klee/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"klee_2.c", metadata !"/home/lijiaying/Research/github/FIIF/examples/f1a/klee/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_c
