...
entry:
  ...
  %7 = icmp sgt i32 %6, -1, !dbg !129
  %8 = zext i1 %7 to i64, !dbg !129
  call void @klee_assume(i64 %8) nounwind, !dbg !129
  %9 = load i32* %y, align 4, !dbg !130
  %10 = icmp slt i32 %9, 0, !dbg !130
  br i1 %10, label %bb, label %bb3, !dbg !130

bb:                                               ; preds = %entry
  %11 = call i32 (...)* @__assert_fail(i8* getelementptr inbounds ([7 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8]* @.str3, i64 0, i64 0), i32 17, i8* getelementptr inbounds ([5 x i8]* @__PRETTY_FUNCTION__.2613, i64 0, i64 0)) nounw
  unreachable

bb3:                                              ; preds = %entry
  store i32 0, i32* %0, align 4, !dbg !131
  %12 = load i32* %0, align 4, !dbg !131
  store i32 %12, i32* %retval, align 4, !dbg !131
...
!1 = metadata !{i32 589865, metadata !"klee_3.c", metadata !"/home/lijiaying/Research/github/FIIF/examples/f1a/klee/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"klee_3.c", metadata !"/home/lijiaying/Research/github/FIIF/examples/f1a/klee/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_c
