...
public:
	...
	SVM_I(void(*f) (const char*) = NULL, const Equation& eq = NULL, int equ = 8) : SVM(f), max_equ(equ) {
		problem1.l = 0;
		problem2.l = 0;
	...
	friend std::ostream& operator << (std::ostream& out, const SVM_I si) {
