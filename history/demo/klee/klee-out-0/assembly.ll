...
@.str2 = private unnamed_addr constant [18 x i8] c"xa + 2 * ya >= -1\00", align 1
@.str3 = private unnamed_addr constant [9 x i8] c"klee_1.c\00", align 1
@__PRETTY_FUNCTION__.2615 = internal unnamed_addr constant [5 x i8] c"main\00"
...
entry:
  ...
  %1 = load i32* %ya, align 4, !dbg !128
  %2 = mul nsw i32 %1, 2, !dbg !128
  %3 = load i32* %xa, align 4, !dbg !128
  %4 = add nsw i32 %2, %3, !dbg !128
  %5 = icmp sge i32 %4, 0, !dbg !128
  %6 = zext i1 %5 to i64, !dbg !128
  call void @klee_assume(i64 %6) nounwind, !dbg !128
  %7 = load i32* %ya, align 4, !dbg !129
  %8 = mul nsw i32 %7, 2, !dbg !129
  %9 = load i32* %xa, align 4, !dbg !129
  %10 = add nsw i32 %8, %9, !dbg !129
  %11 = icmp slt i32 %10, -1, !dbg !129
  br i1 %11, label %bb, label %bb3, !dbg !129

bb:                                               ; preds = %entry
  %12 = call i32 (...)* @__assert_fail(i8* getelementptr inbounds ([18 x i8]* @.str2, i64 0, i64 0), i8* getelementptr inbounds ([9 x i8]* @.str3, i64 0, i64 0), i32 15, i8* getelementptr inbounds ([5 x i8]* @__PRETTY_FUNCTION__.2615, i64 0, i64 0)) noun
  unreachable

bb3:                                              ; preds = %entry
  store i32 0, i32* %0, align 4, !dbg !130
  %13 = load i32* %0, align 4, !dbg !130
  store i32 %13, i32* %retval, align 4, !dbg !130
  %retval4 = load i32* %retval, !dbg !130
  ret i32 %retval4, !dbg !130
}
...
!1 = metadata !{i32 589865, metadata !"klee_1.c", metadata !"/home/lijiaying/Research/github/FIIF/demo/klee/", metadata !2} ; [ DW_TAG_file_type ]
!2 = metadata !{i32 589841, i32 0, i32 1, metadata !"klee_1.c", metadata !"/home/lijiaying/Research/github/FIIF/demo/klee/", metadata !"4.2.1 (Based on Apple Inc. build 5658) (LLVM build 2.9)", i1 true, i1 false, metadata !"", i32 0} ; [ DW_TAG_compile_u
...
!125 = metadata !{i32 12, i32 0, metadata !126, null}
!126 = metadata !{i32 589835, metadata !0, i32 7, i32 0, metadata !1, i32 0} ; [ DW_TAG_lexical_block ]
!127 = metadata !{i32 13, i32 0, metadata !126, null}
!128 = metadata !{i32 14, i32 0, metadata !126, null}
!129 = metadata !{i32 15, i32 0, metadata !126, null}
!130 = metadata !{i32 16, i32 0, metadata !126, null}
